 ...
 */
export function parseParentIdFromQuery(request: NextRequest): string | null | undefined {
  const searchParams = request.nextUrl.searchParams;
 ...
 */
export function parseFileTypeFromQuery(request: NextRequest): 'file' | 'folder' | null {
  const searchParams = request.nextUrl.searchParams;
